...
public class CoursesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerCourses =
                findViewById(R.id.recyclerCourses);

        btnAddCourse =
                findViewById(R.id.btnAddCourse);

        btnChecklist =
                findViewById(R.id.btnChecklist);
        ...
        adapter =
                new CourseAdapter(filteredList);
    ...
    private void showAddCourseDialog() {
        ...
        inputName.setHint(
                "Course Name (e.g. CMPS 279)");

        inputName.setInputType(
                InputType.TYPE_CLASS_TEXT);

        EditText inputSemester =
                new EditText(this);

        inputSemester.setHint(
                "Semester (e.g. Spring 2026)");

        inputSemester.setInputType(
                InputType.TYPE_CLASS_TEXT);
